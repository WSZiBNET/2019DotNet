...
namespace panda3.Controllers
{
    public class ZnizkiController : Controller
    {
        ...
        public ZnizkiController(KomputerDbContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.ZnizkiModel.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var znizkiModel = await _context.ZnizkiModel
                .SingleOrDefaultAsync(m => m.ZnizkiId == id);
            if (znizkiModel == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var znizkiModel = await _context.ZnizkiModel.SingleOrDefaultAsync(m => m.ZnizkiId == id);
            if (znizkiModel == null)
            {
                return NotFound();
            }
        ...
        {
            var znizkiModel = await _context.ZnizkiModel.SingleOrDefaultAsync(m => m.ZnizkiId == id);
            _context.ZnizkiModel.Remove(znizkiModel);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.ZnizkiModel.Any(e => e.ZnizkiId == id);
        }
    }
}
