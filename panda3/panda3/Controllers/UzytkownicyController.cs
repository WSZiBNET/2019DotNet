...
namespace panda3.Controllers
{
    public class UzytkownicyController : Controller
    {
        ...
        public UzytkownicyController(KomputerDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var uzytkownicyModel = await _context.Uzytkownicy
                .SingleOrDefaultAsync(m => m.UzytkownikId == id);
        ...
        public async Task<IActionResult> Create([Bind("UzytkownikId,Login,Haslo,Email,CzyAdmin")] UzytkownicyModel uzytkownicyModel)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var uzytkownicyModel = await _context.Uzytkownicy.SingleOrDefaultAsync(m => m.UzytkownikId == id);
            if (uzytkownicyModel == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UzytkownikId,Login,Haslo,Email,CzyAdmin")] UzytkownicyModel uzytkownicyModel)
        {
